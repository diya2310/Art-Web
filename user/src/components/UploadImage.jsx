...
function UploadImage({setFile}) {
   ...
   const [selectedFile,setSelectedFile] = useState();
	...
	return (
		...
		<div className='h-[450px] bg-[#e9e9e9] rounded-lg dark:bg-[#272727]'>
			...
			<label className='m-5 flex flex-col justify-center items-center cursor-pointer h-[90%] border-[2px] border-gray-300 border-dashed rounded-lg text-gray-600 '>
				
				{
					!selectedFile ?
						<div className='flex items-center flex-col'>
							<BsBoxArrowUp className='text-[22px]'/>   
				...
				{
					selectedFile ?
						<img src={window.URL.createObjectURL(selectedFile)} 			alt='' width={500} height={800}
